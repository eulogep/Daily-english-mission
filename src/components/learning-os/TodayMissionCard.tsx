...
export function TodayMissionCard() {
  ...
  const action = status === "COMPLETED" ? "Voir ma progression" : status === "IN_PROGRESS" || status === "PAUSED" ? "Reprendre la mission" : "Commencer la mission";
  const actionHref = status === "COMPLETED" ? "/progress" : "/learn/excel-csv-foundations-level-1";
